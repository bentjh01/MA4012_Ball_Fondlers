...
void robot_execute(){
	...
	robot_move_closed(robot_cmd_linX, robot_cmd_angZ, robot_en_rpmL, robot_en_rpmR);
...
void init_robot(){
	...
	while (ready != 1){
		...
		if (robot_arm_position < 180.0){
			robot_arm_move(180.0, robot_arm_position);
		}
		else{
			robot_arm_move(0.0, robot_arm_position);
		}
